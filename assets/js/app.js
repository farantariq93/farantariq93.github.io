                ...
                $this.submit(function() {
                    ...
                    $.ajax({
                        ...
                        success: function success(data) {
                            ...
                            $('.form-body', $this).html('<img src="media/services/thumbsup--cartoon.png">');
                        },
...
jQuery(document).ready(function(){
    jQuery('.bot-link .close-icon').click(function(){
        jQuery('.box-content').hide();
        jQuery(this).hide();
        jQuery("iframe#bot").toggleClass('open');
    });

    if (jQuery(window).width() < 480) {
       jQuery("iframe#bot").height('400');
    }    
});
...
jQuery(document).ready(function(){
    ...
    jQuery('.bot-image').click(function(){
        jQuery('.bot-link .box-content').toggle();
        jQuery('.bot-link .close-icon').toggle();

        if((jQuery("iframe#bot").hasClass("loaded"))){
            jQuery('iframe#bot').attr('src', 'https://app.conversiobot.com/boot/YiSVVd').show();
            jQuery("iframe#bot").removeClass('loaded');
        }
    })
});